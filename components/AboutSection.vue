      ...
      <div class="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-16 lg:items-start">
        ...
        <div class="lg:col-span-7">
          <div class="space-y-6 text-slate-200">
            ...
            <p class="leading-relaxed">
              AI has fundamentally changed how I work. I no longer manage products from a distance. I plan and prioritize work, design interfaces, record and publish product videos, and write code to ship and communicate with users.
            </p>
            <p class="leading-relaxed">
